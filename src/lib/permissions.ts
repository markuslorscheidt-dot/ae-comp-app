...
export function canViewAllUsers(role: UserRole): boolean {
  return role === 'country_manager' || role === 'line_manager' || role === 'ae' || role === 'sdr';
}
...
export function canEnterOwnGoLives(role: UserRole): boolean {
  return role === 'country_manager' || role === 'line_manager' || role === 'ae';
}
...
export function getAssignableRoles(userRole: UserRole): UserRole[] {
  if (userRole === 'country_manager') {
    return ['country_manager', 'line_manager', 'ae', 'sdr', 'sonstiges'];
  }
